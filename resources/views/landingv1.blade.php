...
<head>
   ...
   <meta name="keywords" content="forex hesap aç,forex hesap, forex kayıt, forex borsası, ekolfx, yurtdışı forex, en iyi forex, forex yatırım, forex nedir, en güvenilir forex, forex demo hesabı, ücretsiz forex hesabı, limitsiz forex hesabı">
            ...
            <div class="homePreviewBotTab">
                <a href="/demo">
                    <ul class="sul">
                        ...
                        <li class="desc">Gerçek Forex piyasa koşullarında yatırım yapmadan demo forex hesap ile işlem yapma imkanı</li>
                    </ul>
                </a>
            </div>
            <!--.tab-->
                ...
                <div class="fw threeStepsBox">
                    <div class="fw threeStepTab wow fadeIn">
                        <ul class="sul">
                            ...
                            <li class="desc">Hemen, 2 dakikanınızı ayırarak ücretsiz forex hesap oluşturun ve size özel olarak atanacak olan müşteri temsilcisi sizi arasın!</li>
                        </ul>
                    </div>
                    <!--.tab-->
                    <div class="fw threeStepTab wow fadeIn">
                        <ul class="sul">
                            ...
                            <li class="desc">70 Ödeme yöntemimizden birini kullanarak, kolayca <b>forex yatırımı</b> yapabilirsiniz!  7/24 Para Yatırma - Çekme işlemi yapabileceğiniz tek kurum: Ekol Forex.</li>
                        </ul>
                    </div>
                    <!--.tab-->
                    <div class="fw threeStepTab wow fadeIn">
                ...
                <div class="homeYatirimLeft">
                    <div class="fw homeYatirimLeftBox">
                        <ul class="sul">
                            ...
                            <li class="desc">Hemen gerçek Forex Hesabı oluşturarak, Dünya piyasalarında Spot Metaller, Endeksler, Spot Emtialar, Kripto Para Birimleri, ABD Hisseleri, AB Hisseleri, ASYA Hisseleri ve RUSYA hisseleri yatırımları ile kazanç sağlamaya başlayın!</li>
                        </ul>
                    </div>
                    <!--.box-->
                </div>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="fw homePlatformRight">
                            <div class="fw simpleTitle" style="padding-bottom: 0px;">
                                <ul class="sul">
                                    <li class="subTitle"><span class="subTitleX">SIKÇA SORULAN <strong> SORULAR</strong></span></li>
                                </ul>
                            ...
                            <div class="fw faqListTab">
                                ...
                                <div class="fw faqListTabContent" style="display: none;">
                                    <div class="fw simpleContent">
                                        <p><b>Demo forex hesap aç</b> formumuzu doldurarak müşteri temsilcilerimizin sizi aramasını sağlayabilir ya da canlı desteğe bağlanarak hesabınızı açabilirsiniz.</p>
                                    </div>
                                    <!--.content-->
                                </div>
                                <!--.content-->
                            ...
                            <div class="fw faqListTab">
                                ...
                                <div class="fw faqListTabContent">
                                    <div class="fw simpleContent">
                                        <p>EKOL Forex'te 70'den fazla ödeme yöntemi ile 7/24 para yatırma işlemi gerçekleştirebilirsiniz.</p>
                                    </div>
                                    <!--.content-->
                                </div>
                                <!--.content-->
                            ...
                            <div class="fw faqListTab">
                                ...
                                <div class="fw faqListTabContent">
                                    <div class="fw simpleContent">
                                        <p>7/24 Para çekme deneyinimi Ekol Fx'te yaşayın. Müşteri panelinden tek tuşla kolayca para çekim talebi gerçekleştirebilirsiniz.</p>
                                    </div>
                                    <!--.content-->
                                </div>
                                <!--.content-->
                            ...
                            <div class="fw faqListTab">
                                ...
                                <div class="fw faqListTabContent">
                                    <div class="fw simpleContent">
                                        <p>Ekol Forex web sitesi tüm platformlara uyumludur. Bilgisayarınız, tabletiniz veya mobil uygulamamız üzerinden işlemlerimize hemen başlayabilirsiniz.</p>
                                    </div>
                                    <!--.content-->
                                </div>
                                <!--.content-->
