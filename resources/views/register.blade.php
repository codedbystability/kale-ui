  ...
  <div class="fw loginPage wow fadeInUp">
    <div class="fw loginPageBox">
      <div class="fw loginPageTop">
        <ul role="tablist">
          <li role="presentation" class="demo"><a href="#login1" role="tab" data-toggle="tab">{{LangValue('register_tab1')}}</a></li>
          <li role="presentation" class="active gercek"><a href="#login2" role="tab" data-toggle="tab">{{LangValue('register_tab2')}}</a></li>
        </ul>
      </div><!--.top-->
      <div class="fw loginPageBot">
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane fade" id="login1">
          ...
          <div role="tabpanel" class="tab-pane fade in active" id="login2">
